...
def _extract_year(sheet) -> int | None:
    """Best-effort extraction of the financial year's start year from a
    period line near the top of the sheet, e.g. Xero's
    'For the period 1 July 2025 to 30 June 2026' or MYOB's
    '01 Apr 2026 - 30 Jun 2026'. Returns None if no such line is found —
